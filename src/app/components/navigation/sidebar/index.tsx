...
const Sidebar = ({
  ...
  return (
    <>
      <div
        className="sidebar-container fixed w-1/2 h-full overflow-y-auto justify-center bg-zinc-800/80   right-0 z-10"
        style={{
          top: ` ${isOpen ? "5rem" : "-100%"}`,
        }}
      >
        <div className="flex flex-col gap-16 text-center mt-16 leading-relaxed ">
          <ul className=" flex flex-col gap-8 items-center justify-evenly w-full ">
            <NavItem
              title={"ABOUT ME"}
              href={"about"}
          ...
          <div className="flex flex-col gap-16 items-center  leading-relaxed">
            <Link
