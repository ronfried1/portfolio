  ...
  return (
    <footer id="contact" className="bg-zinc-800">
      <div className="container flex flex-col gap-16 mx-auto py-6">
        <div className="flex gap-4 mx-4 justify-between  h-full">
          <div className="flex flex-col flex-1  w-full max-w-xl gap-16 ">
          ...
          {/* <div className="flex flex-2 md:flex-initial">
          </div> */}
          <ContactForm />
        </div>
